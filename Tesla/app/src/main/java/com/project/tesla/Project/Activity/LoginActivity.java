...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.project.tesla.R.layout.activity_login);
        Email=findViewById(com.project.tesla.R.id.Email);
        dialog=new ProgressDialog(LoginActivity.this);
        dialog.setMessage("Logging in....");
        db=FirebaseDatabase.getInstance();
        Password=findViewById(com.project.tesla.R.id.login_password);
        login_btn=findViewById(com.project.tesla.R.id.login_btn);
